...
public final class Constants {
    ...
    public static final String ABOUT_DOCUMENT = "<h3>Welcome to " + Identification.APP_NAME + " " + BuildConfig.VERSION_NAME + "!</h3><br/> "
            ...
            + "\">" + Identification.AUTHOR_EMAIL + "</a>&gt; based on the original work of Ernst Jan Plugge who developed the open-source code. The community thanks them for their sterling work. <br/><br/>"
            + " This app has been independently developed, and is not supported by, affiliated with or endorsed by Tofugu.<br/><br/>"
            + Identification.APP_NAME + " uses these Open Source components:<ul>"
